...
import { 
  ...
  CheckCircle2, Circle, AlertCircle, Share2, Copy
} from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          {trip.current_eta_minutes && 
           ['a_caminho', 'passageiro_embarcou', 'a_caminho_destino'].includes(trip.driver_trip_status) && (
            <div className="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-4 shadow-sm animate-in fade-in slide-in-from-bottom-4">
              <p className="text-sm text-blue-600 font-medium mb-1 flex items-center justify-center gap-2">
                <Clock className="w-4 h-4" />
                Previsão de Chegada
              </p>
              <p className="text-4xl font-extrabold text-blue-800 tracking-tight my-2">
                {(() => {
        ...
        <div className="text-center pb-8">
          ...
          <p className="text-xs text-gray-400 mt-4">
            Este link é seguro e atualizado em tempo real.
            <br />
