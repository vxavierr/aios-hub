...
export default function GerenciarVeiculos() {
  ...
  const [formData, setFormData] = useState({
    ...
    description: '',
    base_price_per_km: 0,
    min_km_franchise: 0, // New field
    min_price_for_franchise: 0, // New field
  ...
  const handleEdit = (vehicle) => {
    ...
    setFormData({
      ...
      min_km_franchise: vehicle.min_km_franchise || 0, // New field
      min_price_for_franchise: vehicle.min_price_for_franchise || 0, // New field
