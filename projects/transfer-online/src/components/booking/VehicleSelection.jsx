...
export default function VehicleSelection({ 
  ...
  const handleRequestQuote = async (vehicle, language) => {
    setRequestingQuoteForVehicle(vehicle.id);
    try {
      if (onRequestQuote) {
        await onRequestQuote(vehicle, language);
      }
    } finally {
  ...
  if (isCalculating) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-700 text-base font-medium">Calculando opções...</p>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  Faça login para ver preços e reservar
                </p>
              </div>
            </div>
            <Button
            ...
            >
              <CardContent className="p-0">
                ...
                <div className="p-4 space-y-3 bg-white">
                  ...
                  {vehicle.description && (
                    <p className="text-xs text-gray-600 line-clamp-2">{vehicle.description}</p>
                  )}
                    ...
                    {!isAdminMode && !meetsLeadTime ? (
                      ...
                      isSelected ? (
                        <>
                          ...
                          {isMultiSelectMode ? 'Selecionado' : 'Selecionado'}
                        </>
                      ) : (
                        <>
                          {isMultiSelectMode ? (
