        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-100 p-4 rounded-lg">
            <div className="flex justify-between items-start mb-4">
              <h3 className="font-semibold text-blue-900">Motorista Designado</h3>
              <Button 
                size="sm" 
                variant="outline" 
            ...
            {booking.driver_name ? (
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 font-medium">{booking.driver_name}</span>
                </div>
                <div>
                  <span className="text-blue-700">Telefone:</span>
                  <span className="ml-2 font-medium">{booking.driver_phone}</span>
                </div>
                <div>
                  <span className="text-blue-700">Carro:</span>
                  <span className="ml-2 font-medium">{booking.vehicle_model} - {booking.vehicle_plate}</span>
                </div>
              </div>
            ) : (
              <div className="text-sm text-blue-800 italic">
                Nenhum motorista designado. Clique em "Gerenciar Motorista" para atribuir.
              </div>
            )}
          </div>
