...
function LayoutContent({ children, currentPageName }) {
  ...
  'SmsLogs', 'GerenciarTemas', 'GerenciarTagsPassageiros', 'MonitoramentoSistema'
  ];
  ...
  React.useEffect(() => {
    ...
    if (isHome) {
      ...
      // Prioridade para www.app.transferonline.com.br -> NovaReserva
      if (hostname === 'www.app.transferonline.com.br') {
         console.log('[Layout] Redirecting www.app... to NovaReserva');
         navigate(createPageUrl('NovaReserva') + location.search, { replace: true });
         return;
      }
      
      // app.transferonline.com.br -> NovaReserva
      if (hostname === 'app.transferonline.com.br') {
         console.log('[Layout] Redirecting app... to NovaReserva');
         navigate(createPageUrl('NovaReserva') + location.search, { replace: true });
         return;
      }
    }
  }, [currentPageName, navigate, location.search]);
  ...
  return (
    <div className="h-screen flex w-full bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-slate-50 relative overflow-hidden">
      <style>{`
        :root {
