...
Deno.serve(async (req) => {
  try {
    ...
    if (recipientType === 'customer' && emailType === 'confirmation') {
      ...
      `;
    } else if (recipientType === 'admin' && emailType === 'new_booking_notification') {
      if (!adminEmail) {
      ...
      toEmail = adminEmail;
      subject = `🆕 Nova Reserva ${bookingData.booking_number || ''} - TransferOnline`;
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 10px 0 0 0; font-size: 16px;">Uma nova reserva foi confirmada no sistema</p>
            </div>
            ...
            <div class="content">
              ...
              <div class="alert">
                <strong>⏰ Ação Necessária:</strong> Uma nova reserva foi confirmada e paga. Providencie a alocação de motorista e veículo.
              </div>
            ...
            <div class="footer">
              <p>TransferOnline - Sistema de Reservas de Transfer</p>
              <p>Este é um e-mail automático de notificação administrativa.</p>
            </div>
          </div>
        </body>
        </html>
      ...
      subject = `Cancelamento e Reembolso - Reserva ${bookingData.booking_number || ''} - TransferOnline`;
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 10px 0 0 0; font-size: 16px;">Sua reserva foi cancelada e o valor será reembolsado</p>
            </div>
            
            <div class="content">
              ${bookingData.booking_number ? `<div class="booking-number">Reserva: ${bookingData.booking_number}</div>` : ''}

              <p>Olá <strong>${bookingData.customer_name || 'Cliente'}</strong>,</p>
              <p>Informamos que sua reserva de transfer foi cancelada. ${refundReason ? `<strong>Motivo:</strong> ${refundReason}` : ''}</p>
              <p>Pedimos desculpas pelo transtorno e o valor pago será reembolsado integralmente.</p>

              <div class="refund-box">
                <h3 style="margin: 0 0 10px 0; color: #10b981;">💳 Reembolso Processado</h3>
                <div class="refund-amount">
                  ${formatPrice(bookingData.total_price)}
                </div>
                <p style="margin: 10px 0 0 0; color: #6b7280; font-size: 14px;">
                  O valor será estornado no seu cartão de crédito em até 5-10 dias úteis
                </p>
              </div>

              <div class="section">
                <h2>📋 Detalhes da Reserva Cancelada</h2>
                <div class="info-row">
                  <span class="info-label">Origem:</span>
                  <span class="info-value">${bookingData.origin || '-'}</span>
                </div>
                ...
                <div class="info-row">
                  ...
                  <span class="info-value">Ida e Volta</span>
                </div>
                ` : ''}
              </div>
              ...
              <div class="highlight">
                ...
                <ul style="margin: 10px 0;">
                  <li>O reembolso foi processado com sucesso na operadora de cartão</li>
                  <li>O prazo para o estorno aparecer na sua fatura é de 5 a 10 dias úteis</li>
                  <li>Caso tenha dúvidas, entre em contato conosco</li>
                  <li>Você pode fazer uma nova reserva a qualquer momento em nosso site</li>
                </ul>
              </div>

              <p style="text-align: center; margin-top: 30px;">
                Agradecemos a compreensão e esperamos servi-lo novamente em breve.<br>
      ...
      subject = `Complete seu Pagamento - Reserva ${bookingData.booking_number || ''} - TransferOnline`;
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p style="margin: 10px 0 0 0; font-size: 16px;">Finalize sua reserva em poucos cliques</p>
            </div>
            ...
            <div class="content">
              ...
              <p>Olá <strong>${bookingData.customer_name || 'Cliente'}</strong>,</p>
              <p>Notamos que você iniciou uma reserva conosco, mas o pagamento ainda não foi concluído. Não se preocupe, sua reserva está guardada e você pode finalizar o pagamento agora mesmo!</p>
              ...
              <div class="alert">
                <strong>⚡ Ação Necessária:</strong> Para garantir sua reserva, por favor complete o pagamento o mais breve possível. Após o pagamento, você receberá um e-mail de confirmação com todos os detalhes.
              </div>
              ...
              <div style="text-align: center; margin: 30px 0;">
                <p style="font-size: 14px; color: #6b7280;">
                  Caso o botão acima não funcione, copie e cole este link no seu navegador:
                </p>
              ...
              <p style="text-align: center; margin-top: 30px; color: #6b7280;">
                Estamos à disposição para qualquer dúvida!<br>
                Equipe TransferOnline 🚗
              </p>
            </div>
    ...
    // NOVO: Enviar WhatsApp após e-mail (apenas para confirmação e nova reserva)
    if ((recipientType === 'customer' && emailType === 'confirmation') || 
        (recipientType === 'admin' && emailType === 'new_booking_notification')) {
      try {
        console.log("Tentando enviar WhatsApp também...");
