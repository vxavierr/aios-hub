...
commands:
  ...
  - name: onboarding-tracking
    description: "Setup de tracking de novo cliente (pixels, tags, conversões)"
    task: tasks/nova/onboarding-tracking.md
    usage: "*onboarding-tracking {cliente}"
...
workflows:
  - "*ciclo-semanal — Ciclo semanal (Nova executa: Extração/Normalização + Análise + Diagnóstico + Leads)"
  - "*ciclo-mensal — Ciclo mensal (Nova executa: Extração + Análise Big Numbers + Diagnóstico + Leads)"
